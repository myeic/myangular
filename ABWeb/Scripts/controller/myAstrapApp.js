...
angular.module('myAstrapApp', ['ngAnimate', 'ngSanitize', 'mgcrea.ngStrap'])
...
.controller('ModalDemoCtrl', function ($scope, $modal) {
    ...
    //var myModal = $modal({ controller: MyModalController, templateUrl: 'AStrap/ModalTplView', show: false });
...
.controller('SelectDemoCtrl', function ($scope, $http) {
    ...
    $scope.aa = function () { alert($scope.selectedIcons); };

    $scope.bb = function () { alert($scope.selectedIcon);};
})
